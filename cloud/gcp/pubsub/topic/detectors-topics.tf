resource "signalfx_detector" "sending_operations" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.sending_operations_threshold_critical}, ${var.sending_operations_threshold_critical}, 'below', lasting('${var.sending_operations_aperiodic_duration}', ${var.sending_operations_aperiodic_percentage}), 'observed')
...
resource "signalfx_detector" "unavailable_sending_operations" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.unavailable_sending_operations_threshold_critical}, ${var.unavailable_sending_operations_threshold_critical}, 'above', lasting('${var.unavailable_sending_operations_aperiodic_duration}', ${var.unavailable_sending_operations_aperiodic_percentage}), 'observed')
...
resource "signalfx_detector" "unavailable_sending_operations_ratio" {
  ...
  program_text = <<-EOF
		...
		ON_Condition_CRIT = conditions.generic_condition(signal, ${var.unavailable_sending_operations_ratio_threshold_critical}, ${var.unavailable_sending_operations_ratio_threshold_critical}, 'above', lasting('${var.unavailable_sending_operations_ratio_aperiodic_duration}', ${var.unavailable_sending_operations_ratio_aperiodic_percentage}), 'observed')
