resource "signalfx_detector" "sending_operations" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.sending_operations_threshold_warning}, 'below', lasting('${var.sending_operations_aperiodic_duration}', ${var.sending_operations_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "unavailable_sending_operations" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.unavailable_sending_operations_threshold_warning}, 'above', lasting('${var.unavailable_sending_operations_aperiodic_duration}', ${var.unavailable_sending_operations_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "unavailable_sending_operations_ratio" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.unavailable_sending_operations_ratio_threshold_warning}, 'above', lasting('${var.unavailable_sending_operations_ratio_aperiodic_duration}', ${var.unavailable_sending_operations_ratio_aperiodic_percentage})).publish('WARN')
	EOF
