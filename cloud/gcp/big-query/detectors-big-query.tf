...
resource "signalfx_detector" "concurrent_queries" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.concurrent_queries_threshold_warning}, 'above', lasting('${var.concurrent_queries_aperiodic_duration}', ${var.concurrent_queries_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "execution_time" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.execution_time_threshold_warning}, 'above', lasting('${var.execution_time_aperiodic_duration}', ${var.execution_time_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "scanned_bytes" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.scanned_bytes_threshold_warning}, 'above', lasting('${var.scanned_bytes_aperiodic_duration}', ${var.scanned_bytes_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "scanned_bytes_billed" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.scanned_bytes_billed_threshold_warning}, 'above', lasting('${var.scanned_bytes_billed_aperiodic_duration}', ${var.scanned_bytes_billed_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "available_slots" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.available_slots_threshold_warning}, 'below', lasting('${var.available_slots_aperiodic_duration}', ${var.available_slots_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "stored_bytes" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.stored_bytes_threshold_warning}, 'above', lasting('${var.stored_bytes_aperiodic_duration}', ${var.stored_bytes_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "table_count" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.table_count_threshold_warning}, 'above', lasting('${var.table_count_aperiodic_duration}', ${var.table_count_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "uploaded_bytes" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.uploaded_bytes_threshold_warning}, 'above', lasting('${var.uploaded_bytes_aperiodic_duration}', ${var.uploaded_bytes_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "uploaded_bytes_billed" {
	...
	program_text = <<-EOF
		...
		aperiodic.above_or_below_detector(signal, ${var.uploaded_bytes_billed_threshold_warning}, 'above', lasting('${var.uploaded_bytes_billed_aperiodic_duration}', ${var.uploaded_bytes_billed_aperiodic_percentage})).publish('WARN')
	EOF
