...
resource "signalfx_detector" "jvm_gc_old_collection_latency" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.jvm_gc_old_collection_latency_threshold_warning}, ${var.jvm_gc_old_collection_latency_threshold_critical}, 'within_range', lasting('${var.jvm_gc_old_collection_latency_aperiodic_duration}', ${var.jvm_gc_old_collection_latency_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "jvm_gc_young_collection_latency" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.jvm_gc_young_collection_latency_threshold_warning}, ${var.jvm_gc_young_collection_latency_threshold_critical}, 'within_range', lasting('${var.jvm_gc_young_collection_latency_aperiodic_duration}', ${var.jvm_gc_young_collection_latency_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "indexing_latency" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.indexing_latency_threshold_warning}, ${var.indexing_latency_threshold_critical}, 'within_range', lasting('${var.indexing_latency_aperiodic_duration}', ${var.indexing_latency_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "flush_latency" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.flush_latency_threshold_warning}, ${var.flush_latency_threshold_critical}, 'within_range', lasting('${var.flush_latency_aperiodic_duration}', ${var.flush_latency_aperiodic_percentage})).publish('WARN')
	EOF
...
resource "signalfx_detector" "search_query_latency" {
	...
	program_text = <<-EOF
		...
		aperiodic.range_detector(signal, ${var.search_query_latency_threshold_warning}, ${var.search_query_latency_threshold_critical}, 'within_range', lasting('${var.search_query_latency_aperiodic_duration}', ${var.search_query_latency_aperiodic_percentage})).publish('WARN')
	EOF
